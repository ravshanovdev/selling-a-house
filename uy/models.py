...
class Schedule(models.Model):
    ...
    price_prefix = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    price_suffix = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    price_custom = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
